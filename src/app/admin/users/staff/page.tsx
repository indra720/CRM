...
export default function StaffManagementPage() {
  ...
  return (
    <div className="space-y-6 relative">
      <h1 className="text-2xl font-medium tracking-tight">Staff Users</h1>
     <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-2">
      ...
      <div className="grid gap-4">
        ...
        <CardHeader className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            ...
            <Button
              size="icon"
              className="sm:hidden bg-orange-500 hover:bg-orange-600"
            ...
            <Button
              className="hidden sm:flex bg-orange-500 hover:bg-orange-600 text-white rounded-xl"
              onClick={handleOpenAddForm}
            >
                            ...
                            <div className="px-4 py-6 md:px-8 md:py-7 bg-gradient-to-b from-muted/60 to-muted/30 rounded-xl mx-2 md:mx-4 my-3 shadow-inner">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 text-sm">
                                ...
                                <div className="space-y-5">
                                  ...
                                  <ReviewDetailItem
                                    label="Created Date"
                                    value={new Date(user.created_date)
                                  ...
                                  <div className="space-y-2">
                                    ...
                                    <Link href="/admin/leads/staff">
                                      <Button
                                        variant="outline"
                                        size="sm"
                                        className="w-full text-green-600 border-green-600 hover:bg-green-100 hover:text-green-700"
                                      >
                              ...
                              <div className="mt-6 md:mt-8 flex justify-end border-t pt-5">
                                <Button
                                  ...
                                  onClick={() => handleOpenEditForm(user)}
                                >
                                  <Pencil className="mr-2 h-4 w-4" /> Edit Staff
                                </Button>
                              </div>
                            </div>
                          </TableCell>
      ...
      <Dialog open={isAddFormOpen} onOpenChange={setIsAddFormOpen}>
        <DialogContent className="sm:max-w-3xl max-h-[90vh] p-0 rounded-2xl shadow-2xl flex flex-col">
          ...
          >
            <div className="px-6 pt-4 flex gap-4 flex-col sm:flex-row">
              <Select
                onValueChange={(value) =>
                  handleAddFormSelectChange("admin", value)
                }
                name="admin"
              ...
              <Select
                onValueChange={(value) =>
                  handleAddFormSelectChange("teamLeader", value)
                }
                name="teamLeader"
