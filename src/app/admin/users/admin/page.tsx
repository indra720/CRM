...
const kpiData = [
    { title: "Pending FollowUps", valueKey: "total_pending_followup", icon: Clock, color: "text-yellow-500", link: "/admin/reports/pending-followups" },
    { title: "Tomorrow FollowUps", valueKey: "total_tomorrow_followup", icon: Phone, color: "text-blue-500", link: "/admin/reports/tomorrow-followups" },
    { title: "Today FollowUps", valueKey: "total_today_followup", icon: Phone, color: "text-purple-500", link: "/admin/reports/today-followups" },
    { title: "Upload Leads", valueKey: "total_upload_leads", icon: FileUp, color: "text-sky-500", link: "/admin/upload-leads" },
    { title: "Remaining Leads", valueKey: "total_left_leads", icon: Users, color: "text-indigo-500", link: "/admin/reports/remaining-leads"},
    { title: "Total Lead", valueKey: "total_assign_leads", icon: Users, color: "text-rose-500", link: "/admin/reports/total-leads" },
    { title: "Total Visits", valueKey: "total_visits", icon: Eye, color: "text-green-500", link: "/admin/reports/visit" },
