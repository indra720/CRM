...
const kpiData = [
  {
    ...
    link: "/superadmin/reports/pending-followups",
  },
  {
    ...
    icon: Phone,
    color: "text-blue-500",
    link: "/superadmin/reports/tomorrow-followups",
  },
  {
    ...
    link: "/superadmin/reports/today-followups",
  },
  {
    title: "Upload Leads",
  ...
  },
  {
    ...
    link: "/superadmin/reports/remaining-leads",
  },
  {
    title: "Total Lead",
    ...
    icon: Users,
    color: "text-rose-500",
    link: "/superadmin/reports/total-leads",
  },
  {
    title: "Total Visits",
  ...
  },
  {
    ...
    icon: Check,
    color: "text-teal-500",
    link: "/superadmin/reports/interested",
  },
  {
    ...
    icon: XCircle,
    color: "text-red-500",
    link: "/superadmin/reports/not-interested",
  },
  {
    ...
    link: "/superadmin/reports/other-location",
  },
  {
    title: "Not Picked",
    ...
    link: "/superadmin/reports/not-picked",
  },
];
...
export default function AdminManagementPage() {
      ...
      <Card className="h-28 w-full shadow-md rounded-xl hover:shadow-lg transition-all duration-300 bg-white/5 border border-white/10">
        <CardContent className="p-2 flex flex-col items-center justify-center text-center h-full">
          <motion.div
            ...
            className={`text-2xl ${color} mb-1 flex items-center justify-center`}
          >
         ...
         <CardContent className='p-2 md:p-2 md:pt-0'>
              ...
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="hidden sm:table-cell min-w-[100px] md:min-w-0">Mobile</TableHead>
                  <TableHead className="hidden md:table-cell min-w-[100px] md:min-w-0">
                    Created Date
                  </TableHead>
                  <TableHead className="text-center min-w-[100px] md:min-w-0">Active</TableHead>
  ...
  <Dialog open={isEditFormOpen} onOpenChange={setIsEditFormOpen}>
    ...
    >
      {/* Header */}
      <DialogHeader className="p-5 pb-0 text-center bg-orange-50/70 border-b border-orange-100 flex-shrink-0">
      ...
      <form
        ...
        className="space-y-3 p-3.5 overflow-y-auto flex-1"
      >
        {/* Name */}
        ...
        <DialogFooter
          className="
            flex justify-center gap-3 pt-4 border-t border-gray-200 mt-2 flex-shrink-0
          "
        >
          <Button
            type="button"
