...
const kpiData = [
    ...
    { title: "Tomorrow FollowUps", valueKey: "total_tomorrow_followup", icon: Phone, color: "text-blue-500", link: "/superadmin/reports/tomorrow-followups" },
    { title: "Today FollowUps", valueKey: "total_today_followup", icon: Phone, color: "text-purple-500", link: "/superadmin/reports/today-followups" },
    { title: "Upload Leads", valueKey: "total_upload_leads", icon: FileUp, color: "text-sky-500", link: "/superadmin/upload-leads" },
    { title: "Remaining Leads", valueKey: "total_left_leads", icon: Users, color: "text-indigo-500", link: "/superadmin/reports/remaining-leads"},
    { title: "Total Lead", valueKey: "total_assign_leads", icon: Users, color: "text-rose-500", link: "/superadmin/reports/total-leads" },
    { title: "Total Visits", valueKey: "total_visits", icon: Eye, color: "text-green-500", link: "/superadmin/reports/visit" },
...
export default function AdminManagementPage() {
  ...
  return (
    ...
    <Dialog open={isAddFormOpen} onOpenChange={setIsAddFormOpen}>
        <DialogContent className="w-[95vw] sm:max-w-3xl max-h-[90vh] p-4 rounded-2xl shadow-2xl flex flex-col">
    ...
    {editingUser && (
      <Dialog open={isEditFormOpen} onOpenChange={setIsEditFormOpen}>
        <DialogContent className="w-[95vw] sm:max-w-lg rounded-xl p-4 max-h-[90vh] flex flex-col">
          <DialogHeader className="p-6 pb-4 text-center bg-muted/20 border-b border-border flex-shrink-0">
            <DialogTitle className="text-2xl font-bold text-foreground">Edit Admin</DialogTitle>
            <DialogDescription className="text-muted-foreground">
              Update the details for <span className="font-semibold">{editingUser.name}</span>.
            </DialogDescription>
          </DialogHeader>
          <form onSubmit={handleEditSubmit} className="space-y-4 p-6 overflow-y-auto flex-1">
            ...
            <DialogFooter className="flex flex-row justify-end gap-2 pt-4 flex-shrink-0">
            ...
            {selectedUser && (
              <DetailsDialog 
                  ...
                  details={[
                    ...
                    { label: "Created Date", value: new Date(selectedUser.created_date).toLocaleDateString(), icon: Calendar },
                    {
                      label: "Active Status",
                      type: 'switch',
