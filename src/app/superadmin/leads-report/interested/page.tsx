  ...
  const table = useReactTable({
    ...
    columns: [
      ...
      },
      {
        ...
        header: 'Team Leader',
        cell: ({ row }) => <div className="capitalize">{row.original.team_leader?.name || 'N/A'}</div>,
        meta: {
                              ...
                              <div className="p-4">
                                <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                                  ...
                                  <div className="p-4 grid grid-cols-1 gap-4">
                                    ...
                                    <div className="flex items-center"> {/* New Team Leader detail */}
                                      <Users className="h-4 w-4 mr-3 text-gray-500" />
                                      <span className="text-sm">Team Leader: {row.original.team_leader?.name || 'N/A'}</span>
                                    </div>
                                    <div className="flex items-center">
