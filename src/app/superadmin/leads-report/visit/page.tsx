...
import { Phone, MessageSquare, ArrowUpDown, Search, Plus, Minus, Tag, Loader2, History, Calendar, Users } from 'lucide-react';
...
function VisitLeadsPage() {
  ...
  const table = useReactTable({
    ...
    columns: [
      ...
      {
        accessorKey: 'dateTime', // New Date and Time column
      ...
      },
      {
        ...
        meta: {
          className: "hidden md:table-cell text-center", // Already hidden on mobile
        },
      },
    ],
                              ...
                              <div className="p-4 bg-gray-50">
                                <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                                  ...
                                  <div className="p-4 grid grid-cols-1 gap-4">
                                    ...
                                    <div className="flex items-center"> {/* New Staff detail */}
                                      <Users className="h-4 w-4 mr-3 text-gray-500" />
                                      <span className="text-sm">Staff: {row.original.assigned_to?.name || 'N/A'}</span>
                                    </div>
                                    <div className="flex items-center"> {/* New Date/Time detail */}
                                      <Calendar className="h-4 w-4 mr-3 text-gray-500" />
                                      <span className="text-sm">Date/Time: {row.original.dateTime || 'N/A'}</span>
                                    </div>
                                    <div className="flex items-center"> {/* New History detail */}
